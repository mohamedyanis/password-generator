...
## Options:
* [x] Ability to select the stength of the password.
* [x] Ability to choice the length of the password.
...
Home           | Generate
:---------------------:|:------------------:
![screenshoot](screenshots/pg1.png) | ![screenshoot](screenshots/pg2.png)
...
pip install tkinter
```
3. Install this repository, click <a href="https://github.com/mohamedyanis/password-generator/archive/master.zip"> here </a> to install it.
4. Extract the folder
5. Run the ```psd_gen.py``` file
